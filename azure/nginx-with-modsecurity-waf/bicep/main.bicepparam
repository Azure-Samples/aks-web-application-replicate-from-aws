...
param deploymentScriptUri = 'https://raw.githubusercontent.com/azure-samples/aks-web-application-replicate-from-aws/refs/heads/main/azure/nginx-with-modsecurity-waf/bicep/install-nginx-ingress-controller-with-modsecurity.sh'
